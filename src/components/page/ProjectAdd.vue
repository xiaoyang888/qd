            ...
            <div class="form-box">
                <el-form ref="form" :rules="rules" :model="form" label-width="100px">
                    ...
                    <el-form-item label="负责人" prop="leader" required>
                        <el-input v-model="form.leader" suffix-icon="el-icon-s-custom" @focus="clearValidate('leader')"
                                  clearable></el-input>
                    </el-form-item>

                    <el-form-item label="测试人员" prop="tester" required>
                        <el-input v-model="form.tester" suffix-icon="el-icon-user-solid"
                                  @focus="clearValidate('tester')" clearable></el-input>
                    </el-form-item>

                    <el-form-item label="开发人员" prop="programmer" required>
                        <el-input v-model="form.programmer" suffix-icon="el-icon-user-solid"
                                  @focus="clearValidate('programmer')" clearable></el-input>
                    </el-form-item>

                    <el-form-item label="发布应用" prop="publish_app" required>
                        <el-input v-model="form.publish_app" suffix-icon="el-icon-s-promotion"
                                  @focus="clearValidate('publish_app')" clearable></el-input>
                    </el-form-item>
